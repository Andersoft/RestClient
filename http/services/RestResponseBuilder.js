...
var RestResponseBuilder = /** @class */ (function () {
    ...
    RestResponseBuilder.prototype.withMethod = function (method) {
        this.method = method;
        return this;
    };
    RestResponseBuilder.prototype.build = function () {
        ...
        return httpCall().pipe(getResult, operators_1.concatAll());
    };
    RestResponseBuilder.prototype.handleResponse = function (response) {
...
//# sourceMappingURL=RestResponseBuilder.js.map